...
# input image width/height of the yolov5 model, set by command-line argument
INPUT_WIDTH  = 0
INPUT_HEIGHT = 0
...
#         f.write("""classes = 2
# train   = datasets/crowdhuman-%s/train.txt
# valid   = datasets/crowdhuman-%s/test.txt
# names   = datasets/crowdhuman.names
# backup  = backup/\n""" % (args.dim, args.dim))
